...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!data.feedbackNeeded?.trim()) {
      throw new Error('Feedback needed is required');
    }
    ...
    // Build fields dynamically to handle optional fields properly

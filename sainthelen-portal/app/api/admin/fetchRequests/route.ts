      ...
      const data = {
        announcements: announcements.map((r) => ({
          ...
          fields: {
            ...
            'Calendar Event Name': r.calendarEventName,
            'Calendar Event Date': r.calendarEventDate,
            'Calendar Event Start Time': r.calendarEventStartTime,
            'Calendar Event End Time': r.calendarEventEndTime,
            'Calendar Event Description': r.calendarEventDescription,
            'Calendar Event Location': r.calendarEventLocation,
            'Calendar Event Sign Up Link': r.calendarEventSignUpLink,
            'WordPress Event ID': r.wordpressEventId,
            'WordPress Event URL': r.wordpressEventUrl,
            'File Links': r.fileLinks?.join('\n') || '',
            'Sign Up URL': r.signUpUrl,
            'Sign Up Links': r.signUpLinks,
            'Social Consideration': r.socialConsideration,
            'Social What To Know': r.socialWhatToKnow,
            'Social Has Photos': r.socialHasPhotos,

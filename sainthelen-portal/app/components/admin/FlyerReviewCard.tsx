...
export default function FlyerReviewCard({
  ...
  return (
    <motion.div
      ...
      className={`relative overflow-hidden bg-gradient-to-br from-white via-white to-amber-50/30 dark:from-slate-800 dark:via-slate-800 dark:to-amber-900/10 rounded-2xl border transition-all duration-200 hover:shadow-lg ${
    ...
    >
      ...
      {!isUrgent && <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500" />}
      ...
      <div className="p-5 pb-4">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4 min-w-0">
            {/* Icon */}
            <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-900/40 dark:to-amber-900/20 rounded-xl flex items-center justify-center border border-amber-100 dark:border-amber-800/50 shadow-sm">
      ...
      {/* Footer */}
      <div className="px-5 py-4 bg-gradient-to-r from-gray-50/80 via-amber-50/30 to-gray-50/80 dark:from-slate-900/80 dark:via-amber-900/10 dark:to-slate-900/80 border-t border-gray-100/80 dark:border-slate-700/80 space-y-4">
        {f['File Links'] && (
          <div>

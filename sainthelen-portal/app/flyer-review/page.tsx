                    ...
                    <div className="flex text-sm text-gray-600 dark:text-gray-400">
                      ...
                      >
                        ...
                        <input
                          ...
                          className="sr-only"
                          multiple
                          accept="image/*,.heic,.heif,.pdf,application/pdf,.docx,.pptx,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.openxmlformats-officedocument.presentationml.presentation"
